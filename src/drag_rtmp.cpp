...
void DragRTMP::initRectify()
{
    ...
    cv::fisheye::initUndistortRectifyMap(K, D, cv::Mat(), K, imageSize, CV_16SC2, m_map1, m_map2);
}

void DragRTMP::rectifyImg(Mat &img)
{
    remap(img, img, m_map1, m_map2, cv::INTER_LINEAR, cv::BORDER_CONSTANT);
}
